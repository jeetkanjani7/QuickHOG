...
# Includes
INCLUDES  += -I. -I$(CUDA_INSTALL_PATH)/include -I$(COMMONDIR)/inc -I/usr/local/include,-I/usr/local/include/opencv 
...
# Libs
LIB       := -L$(CUDA_INSTALL_PATH)/lib -L$(LIBDIR) -L$(COMMONDIR)/lib/$(OSLOWER) -L/usr/local/lib -L/usr/lib/x86_64-linux-gnu/

#LDLIBS	  := -lfontconfig -lXrender
#GDLIBS 	  := -lfontconfig -lXrender -lfreetype
LIB+=    -lopencv_core -lopencv_imgproc -lopencv_highgui -lpng -ljpeg -ljasper -lrt -lIlmImf -lImath -lIex -lIlmThread -lHalf -lz -llzma -ljbig -lpthread -lGL -L/usr/lib/x86_64-linux-gnu/libtiff.so.5 -ltiff
...
ifneq ($(STATIC_LIB),)
	...
	#fltk
	LIB += -lfltk2 -lXft -lfltk2_images -lXext -lXinerama -lXi -lfontconfig -lXrender -lfontconfig -lXrender -lfreetype
	#boost thread for interface
	LIB += -lboost_thread
	#read images in HOGImage from file
	LIB += -lfreeimage
	LIB += -lboost_system
	LIB +=  -lXrender -lX11 #-lftonconfig
